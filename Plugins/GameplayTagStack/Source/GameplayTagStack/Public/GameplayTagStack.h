...
struct GAMEPLAYTAGSTACK_API FGameplayTagStack : public FFastArraySerializerItem
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GAMEPLAYTAGSTACK_API FGameplayTagStackContainer : public FFastArraySerializer
{
	GENERATED_BODY()
